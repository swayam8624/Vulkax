...
CANONICAL = [
    ...
    ("research/status/REVIEWER_HARDENING_IMPLEMENTATION_2026-09-23.md", "canonical/reviewer-hardening-implementation", True),
    ("research/reviewer_redteam/REVIEWER_THREAT_MATRIX_2026-09-23.md", "canonical/reviewer-threat-matrix", True),
    ("research/validation/post_final_hardening_v1.json", "canonical/post-final-hardening-config", True),
    ("research/validation/iris_freefall_blind_v1.json", "canonical/iris-freefall-blind-config", True),
    ("research/validation/iris_freefall_final_world_manifest_v1.csv", "canonical/iris-freefall-final-world-manifest", True),
    ("research/benchmarks/IRIS_FREEFALL_BLIND_REPLICATION_PROTOCOL_2026-09-23.md", "canonical/iris-freefall-blind-protocol", True),
    ("research/status/IRIS_FREEFALL_V5_VALIDATION_FAILURE_2026-09-23.md", "canonical/iris-freefall-v5-validation-failure", True),
    ("research/validation/iris_freefall_rescue_v6.json", "canonical/iris-freefall-v6-config", True),
    ("research/benchmarks/IRIS_FREEFALL_V6_FRESH_RESCUE_PROTOCOL_2026-09-23.md", "canonical/iris-freefall-v6-protocol", True),
...
GENERATED = [
    ...
    ("publication-validation/reviewer-hardening-manifest.json", "generated/reviewer-hardening-manifest", False),
    ("publication-validation/iris-pendulum-final-test/clustered_statistics/summary.json", "generated/iris-clustered-statistics", False),
    ("publication-validation/iris-pendulum-final-test/clustered_statistics/per_video.csv", "generated/iris-clustered-per-video", False),
    ("publication-validation/iris-pendulum-postfinal-baselines/summary.json", "generated/iris-strong-baselines", False),
    ("publication-validation/iris-pendulum-postfinal-baselines/records.csv", "generated/iris-strong-baseline-records", False),
    ("publication-validation/iris-pendulum-postfinal-proposals/summary.json", "generated/iris-gt-hidden-proposals-summary", False),
    ("publication-validation/iris-pendulum-postfinal-proposals/blind_proposals.csv", "generated/iris-gt-hidden-blind-proposals", False),
    ("publication-validation/iris-pendulum-postfinal-proposals/evaluated_proposals.csv", "generated/iris-gt-hidden-evaluated-proposals", False),
    ("publication-validation/iris-pendulum-postfinal-truth-uncertainty/summary.json", "generated/iris-truth-uncertainty", False),
    ("publication-validation/iris-pendulum-postfinal-truth-uncertainty/cases.csv", "generated/iris-truth-uncertainty-cases", False),
    ("publication-validation/iris-pendulum-postfinal-dependence/summary.json", "generated/iris-channel-dependence", False),
    ("publication-validation/iris-pendulum-postfinal-dependence/summary.csv", "generated/iris-channel-dependence-table", False),
    ("publication-validation/iris-pendulum-postfinal-robustness/summary.json", "generated/iris-robustness", False),
    ("publication-validation/iris-pendulum-postfinal-robustness/summary.csv", "generated/iris-robustness-table", False),
    ("publication-validation/iris-official-reference/manifest.json", "generated/iris-official-reference-manifest", False),
    ("publication-validation/iris-official-reference/selected_reference_rows.csv", "generated/iris-official-reference-table", False),
    ("publication-validation/iris-freefall-development/summary.json", "generated/iris-freefall-development-summary", False),
    ("publication-validation/iris-freefall-validation/summary.json", "generated/iris-freefall-validation-summary", False),
    ("publication-validation/iris-freefall-validation/validation_records.csv", "generated/iris-freefall-validation-records", False),
    ("publication-validation/iris-freefall-final-lock.json", "generated/iris-freefall-final-lock", False),
    ("publication-validation/iris-freefall-final-test/summary.json", "generated/iris-freefall-final-summary", False),
    ("publication-validation/iris-freefall-final-test/validation_records.csv", "generated/iris-freefall-final-records", False),
    ("publication-validation/combined-freefall-final/analysis/summary.json", "generated/combined-freefall-final-summary", False),
    ("publication-validation/iris-freefall-v6-development/summary.json", "generated/iris-freefall-v6-development-summary", False),
    ("publication-validation/iris-freefall-v6-development/take_summary.csv", "generated/iris-freefall-v6-development-takes", False),
    ("publication-validation/iris-freefall-v6-validation/summary.json", "generated/iris-freefall-v6-validation-summary", False),
    ("publication-validation/iris-freefall-v6-validation/validation_records.csv", "generated/iris-freefall-v6-validation-records", False),
    ("publication-validation/iris-freefall-v6-validation/take_summary.csv", "generated/iris-freefall-v6-validation-takes", False),
    ("publication-validation/iris-freefall-v6-final-lock.json", "generated/iris-freefall-v6-final-lock", False),
    ("publication-validation/iris-freefall-v6-final-test/summary.json", "generated/iris-freefall-v6-final-summary", False),
    ("publication-validation/iris-freefall-v6-final-test/validation_records.csv", "generated/iris-freefall-v6-final-records", False),
    ("publication-validation/combined-freefall-v6-final/analysis/summary.json", "generated/combined-freefall-v6-final-analysis", False),
    ("visualization/reviewer-hardening/manifest.json", "generated/reviewer-hardening-visual-manifest", False),
    ("visualization/reviewer-hardening/gt_hidden_rewrite_visual.json", "generated/gt-hidden-rewrite-visual-manifest", False),
]
...
def assemble(repo_root: Path, build_root: Path, out: Path, allow_missing_gauge: bool) -> dict:
    ...
    manifest={
        ...
        "claim_guard":"D2/D3/D4V remain frozen negative; GAUGE prospective validation is information-limited; the locked IRIS pendulum final test provides narrow positive real-video confirmation for the finite-amplitude period probe versus its matched small-angle baseline. The first free-fall V5 held-out validation failed and must remain visible even if the fresh-split V6 rescue later succeeds. Do not generalize the pendulum result to every physical channel or treat 220 rows as 220 independent physical experiments.",
        "artifacts":artifacts,
    }
