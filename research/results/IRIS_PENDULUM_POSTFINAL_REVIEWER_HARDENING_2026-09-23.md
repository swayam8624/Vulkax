...
The blind proposal uses the first 40% of each video. The verification window is
then moved to produce overlap (hoin{0,0.25,0.5,0.75,1}).

| (ho) | n videos | Strict accuracy | Coverage | Median absolute score |
|---:|---:|---:|---:|---:|
