...
<p align="center">
  <strong>▶ Animated preview — click for the full 116-second explainer artifact.</strong><br/>
  GitHub README does not reliably inline-play repository MP4s, so the page uses a real animated GIF preview.
  The full film is generated by the dedicated Reality Probe explainer workflow.
</p>
