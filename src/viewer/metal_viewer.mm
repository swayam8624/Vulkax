...
- (NSDragOperation)draggingEntered:(id<NSDraggingInfo>)sender {
    ...
    if (directory.boolValue || [url.pathExtension.lowercaseString isEqualToString:@"ply"]) return NSDragOperationCopy;
...
- (BOOL)performDragOperation:(id<NSDraggingInfo>)sender {
    ...
    if ([url.pathExtension.lowercaseString isEqualToString:@"ply"]) { [self.renderer loadPlyURL:url]; return YES; }
    return NO;
}
@end
